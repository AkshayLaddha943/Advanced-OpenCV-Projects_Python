...
nose_cascade = cv2.CascadeClassifier('D:\\Python Projects\\OpenCV\\Snapchat_AR\\Nariz.xml')  
...
img_moustache = cv2.imread('D:\Python Projects\OpenCV\Snapchat_AR\MOUSTACHE.png', -1) 
